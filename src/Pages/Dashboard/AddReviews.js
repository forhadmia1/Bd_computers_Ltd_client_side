...
const AddReviews = () => {
    ...
    const handleForm = (e) => {
        ...
        fetch('https://lit-caverns-37458.herokuapp.com/reviews', {
            method: 'POST',
            headers: {
            ...
            <div className='w-10/12  mt-6'>
                ...
                <form onSubmit={handleForm} className='w-full'>
                    <div className="form-control w-full max-w-md">
                        ...
                        <input name='ratings' type="number" placeholder="Ratings" className="input input-bordered w-full max-w-md" required />
                    </div>
                    <div className="form-control w-full max-w-md">
                        <label className="label">
