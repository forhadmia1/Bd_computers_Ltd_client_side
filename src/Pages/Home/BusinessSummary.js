                ...
                <section className="pb-16 text-gray-800 text-center">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 lg:gap-x-0 items-center">
                        ...
                        <div className="mb-12 lg:mb-0 relative">
                            ...
                            <h5 className="text-lg text-blue-600 font-bold mb-4"><CountUp end={400} />+</h5>
                        ...
                        <div className="mb-12 md:mb-0 relative">
                            ...
                            <h5 className="text-lg  text-blue-600 font-bold mb-4"><CountUp end={350} />+</h5>
