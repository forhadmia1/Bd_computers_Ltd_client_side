    ...
    return (
        <footer className="bg-secondary bg-opacity-40">
            <div className="footer p-10 container mx-auto text-base-content">
                <div>
                    <span className="text-secondary text-2xl font-bold">BD Computers LTD</span>
                    <p>Computers Hardware Manufacturer And Supplier</p>
                    <div className="grid grid-flow-col gap-6 text-2xl mt-4">
                ...
                <div>
                    ...
                    <Link to='/' className="link link-hover flex items-center"><MdKeyboardArrowRight className='text-xl' /><span>Home</span></Link>
                    <Link to='/blogs' className="link link-hover flex items-center"><MdKeyboardArrowRight className='text-xl' /><span>Blogs</span></Link>
                    <Link to='/portfolio' className="link link-hover flex items-center"><MdKeyboardArrowRight className='text-xl' /><span>My Portfolio</span></Link>
                </div>
                <div>
